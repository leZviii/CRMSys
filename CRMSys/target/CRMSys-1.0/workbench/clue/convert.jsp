...
<script type="text/javascript">
	$(function(){
		...
		$("#activitySearchModalBtn").click(function (){
                    ...
                    success : function (data){
                        $.each(data,function (index,element){
                            $("#activitySearchBody").append("<tr>")
                                .append("<td><input type='radio' name='select' value='" + element.id + "'/></td>")
                                .append("<td id='" + element.id + "'>" + element.name + "</td>")
        ...
        $("#convertBtn").click(function (){
            if ($("#isCreateTransaction").prop("checked")){
                ...
                // alert("不需要创建交易");
                window.location.href = "workbench/clue/convert.do?clueId=${param.id}&flag=no";
            }
        })
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="activitySearchModalBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
