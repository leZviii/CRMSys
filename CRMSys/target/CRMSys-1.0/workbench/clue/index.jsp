...
<script type="text/javascript">
	...
	clueList = function (pageNo,pageSize){
		$.ajax({
			...
			success : function (data){
				$.each(data.dataList,function (index,element){
					$("#clueListBody").append("<tr>").
						append("<td><input type='checkbox'</td>").
						append("<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href='workbench/clue/detail.do?id=" + element.id + "';\">" + element.fullname + "</a></td>").
						append("<td>" + element.company + "</td>").
						append("<td>" + element.phone + "</td>").
						append("<td>" + element.mphone + "</td>").
						append("<td>" + element.source + "</td>").
						append("<td>" + element.owner + "</td>").
						append("<td>" + element.state + "</td>").
						append("</tr>")
				})
